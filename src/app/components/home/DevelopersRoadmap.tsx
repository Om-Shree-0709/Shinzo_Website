    ...
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-black to-gray-800 text-gray-200 px-6">
      ...
      >
        ...
        <p className="text-lg md:text-xl text-gray-400 leading-relaxed mb-8">
          This section will display the project&apos;s development phases,
          current progress, and upcoming milestones. A clear timeline of our
          roadmap will be added here soon.
        </p>
